...
export function build_svg(container, scores, settings) {
...
export function build_svg_from_score(container, params) {
  var client = new coreapi.Client()
  return client.action(schema, ['score', 'list'], params).then((results) => {
    build_svg(
      container,
      results.scores,
      {
